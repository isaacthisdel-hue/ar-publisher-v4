...
function proxyFromGitHub(githubPath, req, res, depth) {
  ...
  const proxyReq = https.request(options, (proxyRes) => {
    ...
    // Follow GitHub's internal redirects (e.g. /path → /path/)
...
// When host is ar.servision.ca, the path IS the restaurant/branch/dish
...
<body>
<model-viewer src="model.glb" ios-src="model.usdz" ar ar-modes="webxr scene-viewer quick-look" style="display:none">
</model-viewer>
<div class="page">
  ...
  <div class="center-wrap">
    <a rel="ar" href="model.usdz" id="arBtn" class="ar-btn" style="text-decoration:none">
