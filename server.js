...
app.get('/auth/callback', async (req, res) => {
  ...
  try {
    ...
    res.cookie('gh_token', signToken(accessToken), { httpOnly: true, maxAge: 30*24*60*60*1000, sameSite: 'none', secure: true });
...
app.get('/auth/logout', (req, res) => { res.clearCookie('gh_token', { sameSite: 'none', secure: true }); res.redirect('/'); });
