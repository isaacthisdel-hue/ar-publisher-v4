...
<div class="card">
  ...
  <div class="field">
    <label>Brand Name <span style="color:var(--muted);text-transform:none;letter-spacing:0;font-size:10px">(shows on the circle)</span></label>
...
<div class="page">
  <div class="top-label">
    ...
    <span class="top-text">${topLabel}</span>
    <div class="top-line"></div>
  </div>
