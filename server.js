...
<div class="page">
  ...
  <div class="center-wrap">
    <div class="tap-hint" id="txt-hint">Tap to preview</div>
    <button class="ar-btn" id="arBtn">
      ...
      <div class="face">
        ...
        <div class="brand">
          ...
          <div class="brand-sub" id="txt-view">View in AR</div>
        </div>
      </div>
    </button>
    <div class="steps">
...
// Auto detect French vs English
var fr = {
  sub:    'Appuyez pour voir ce plat prendre vie dans votre espace',
  hint:   'Appuyer pour prévisualiser',
  circle: 'Sur votre<br>table',
  view:   'Voir en AR',
  s1:     'Appuyer le cercle',
  s2:     'Pointer vers la table',
  s3:     'Le voir apparaître',
  c1:     'Compatible iPhone & Android',
  c2:     'Sans application'
};
var lang = navigator.language || navigator.userLanguage || '';
if (lang.toLowerCase().startsWith('fr')) {
  document.getElementById('txt-sub').textContent    = fr.sub;
  document.getElementById('txt-hint').textContent   = fr.hint;
  document.getElementById('txt-circle').innerHTML   = fr.circle;
  document.getElementById('txt-view').textContent   = fr.view;
  document.getElementById('txt-s1').textContent     = fr.s1;
  document.getElementById('txt-s2').textContent     = fr.s2;
  document.getElementById('txt-s3').textContent     = fr.s3;
  document.getElementById('txt-c1').textContent     = fr.c1;
  document.getElementById('txt-c2').textContent     = fr.c2;
}
<\/script>
</body>
</html>`;
